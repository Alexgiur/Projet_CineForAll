...
<main class="create-section" style="padding: 60px 20px; display: flex; justify-content: center; align-items: center;">
    <div class="table-container" style="max-width: 600px; width: 100%; text-align: center; padding: 40px;">
        ...
        <div class="table-actions" style="margin-top: 20px; flex-wrap: wrap;">
            <a href="{{ url('/cinemas') }}" class="btn-menu-uniforme" style="padding: 10px 20px; font-size: 1em; text-decoration: none; background-color: #6c757d;">Retour à la liste</a>

            @auth
                @if(Auth::user()->IdTypeRoleUti == 1)
                    <a href="{{ url('/cinemas/' . $cinema->IdCinema . '/edit') }}" class="btn-menu-uniforme" style="padding: 10px 20px; font-size: 1em; text-decoration: none; background-color: var(--blue-btn);">Modifier</a>
