...
<header class="main-header">
    <div class="logo-container"><a href="{{ url('/') }}"><img src="{{ asset('img/logo.jpeg') }}" class="logo"></a></div>
</header>

<main class="create-section">
    <div class="form-container">
        <h1>Modifier le Profil</h1>
        <form action="{{ url('/personnes/' . $personne->Idper) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <a href="{{ url('/personnes') }}" style="display:block; text-align:center; margin-top:15px; color:#777;">Annuler</a>
        </form>
    </div>
</main>
</body>
