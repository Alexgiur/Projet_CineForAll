...
<header class="main-header">
    <div class="logo-container"><a href="{{ url('/') }}"><img src="{{ asset('img/logo.jpeg') }}" alt="Logo" class="logo"></a></div>
    <nav class="main-nav">
        <ul>
            <li><a href="{{ url('/') }}">Accueil</a></li>
            <li><a href="{{ url('/films') }}">Nos Films</a></li>
...
<main class="create-section">
    <div class="form-container">
        ...
        <form action="{{ url('/films/' . $film->IdFilm) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;">
                <a href="{{ url('/films/' . $film->IdFilm) }}" class="btn-submit" style="background-color: #777; text-decoration:none; text-align:center;">Annuler</a>
