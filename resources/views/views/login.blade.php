...
<div class="container-connexion">
    ...
    <div class="bloc-formulaire">
        <h2>Connexion</h2>
        <a href="{{ url('/') }}" style="font-size: 0.9em; color: var(--primary-color); margin-bottom: 20px; display: block;">
        ...
        <p style="margin-top: 20px; text-align: center;">
            Pas encore de compte ? <a href="{{ url('/register') }}" style="color: var(--primary-color); font-weight: bold;">Créer un compte</a>
        </p>
    </div>
</div>
