    ...
    <nav class="main-nav">
        <ul>
            ...
            @if(Auth::check() && Auth::user()->IdTypeRoleUti == 1)
                <li><a href="{{ url('/admin') }}" class="btn-menu-uniforme" style="color:var(--primary-color);">Administration</a></li>
            @endif
    ...
    <div class="admin-buttons-grid">
        ...
        <div class="admin-button">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px; align-items: center;">
                <a href="{{ url('/films/create') }}" class="btn-menu-uniforme" style="width: 80%;">Ajouter un nouveau film</a>
                <a href="{{ url('/films') }}" class="btn-menu-uniforme" style="width: 80%; background-color: #555 !important;">Liste des films (Modif / Suppr)</a>
            </div>
        </div>
        ...
        <div class="admin-button">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px; align-items: center;">
                <a href="{{ url('/personnes') }}" class="btn-menu-uniforme" style="width: 80%;">Accéder aux personnes</a>
            </div>
        </div>
        ...
        <div class="admin-button">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px; align-items: center;">
                <a href="{{ url('/admin/programmations') }}" class="btn-menu-uniforme" style="width: 80%;">Gérer les Séances / Salles</a>
            </div>
        </div>
        ...
        <div class="admin-button">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px; align-items: center;">
                <a href="{{ url('/genre_film') }}" class="btn-menu-uniforme" style="width: 80%;">Accéder aux genres</a>
            </div>
        </div>
        ...
        <div class="admin-button">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px; align-items: center;">
                <a href="{{ url('/cinemas') }}" class="btn-menu-uniforme" style="width: 80%;">Accéder aux cinémas</a>
            </div>
        </div>
        <div class="admin-button">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px; align-items: center;">
                <a href="{{ url('/mes-reservations') }}" class="btn-menu-uniforme" style="width: 80%;">Accéder aux reservations</a>
            </div>
