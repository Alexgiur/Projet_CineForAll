...
<main>
    <div class="genre-table-container">
        ...
        <div class="genre-table-header">
            ...
            <a href="{{ url('/genre_film/create') }}" class="btn-menu-uniforme">+ Ajouter un genre</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="genre-actions">
                            <a href="{{ url('/genre_film/' . $genre->IdGenreFilm . '/edit') }}" class="btn-edit">Modifier</a>
                            <form action="{{ url('/genre_film/' . $genre->IdGenreFilm) }}" method="POST"
        ...
        <div style="margin-top: 25px;">
            <a href="{{ url('/admin') }}" style="color: #555; text-decoration: underline; font-size: 0.95em;">
